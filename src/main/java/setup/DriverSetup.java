...
import java.net.URL;
import static setup.PropertyFiles.NATIVE_TEST_PROPERTIES;
import static setup.PropertyFiles.WEB_TEST_PROPERTIES;
...
public class DriverSetup extends TestProperties {
     ...
     * @throws Exception
     */
    protected void prepareDriver(PropertyFiles propertyFile) throws Exception {
        capabilities = new DesiredCapabilities();
        String browserName;

        // Get Test PropertyFiles according to test type
